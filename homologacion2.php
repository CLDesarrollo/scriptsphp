<?php
    ...
    $mjfreeway = \PhpOffice\PhpSpreadsheet\IOFactory::load("/var/www/html/homologar/ReporteMJ2.xlsx");
    ...
    $spread
        ...
        ->setTitle('HomologacionTransferencia')
        ->setSubject('HomologacionTransferencia')
        ->setDescription('HomologacionTransferencia');
    ...
    for($i = 2 ; $i <= $highestrow ; $i++){
        ...
        $productnameMJ = $mjfreeway->getActiveSheet()->getCellByColumnAndRow(2, $i)->getValue();
        ...
        $sheet->setCellValueByColumnAndRow(2, $i , $mjfreeway->getActiveSheet()->getCellByColumnAndRow(14, $i)->getValue());
        $sheet->setCellValueByColumnAndRow(3, $i , $mjfreeway->getActiveSheet()->getCellByColumnAndRow(6, $i)->getValue() );
        $sheet->setCellValueByColumnAndRow(4, $i , $mjfreeway->getActiveSheet()->getCellByColumnAndRow(15, $i)->getValue() );
        $sheet->setCellValueByColumnAndRow(5, $i , $mjfreeway->getActiveSheet()->getCellByColumnAndRow(3, $i)->getFormattedValue()  );
        $sheet->setCellValueByColumnAndRow(6, $i , $mjfreeway->getActiveSheet()->getCellByColumnAndRow(17, $i)->getValue() );
    }
